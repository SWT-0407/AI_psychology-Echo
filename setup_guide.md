...
本项目当前入口是 `main.py`，包含三个空间：心理评测、AI 树洞、虚拟角色陪伴。旧版 README 中的流程可能与当前代码不完全一致，比赛演示以本文件为准。
...
1. 首页展示三个空间：心理评测、AI 树洞、虚拟角色。
2. 在心理评测中输入一段日记，展示六维状态和报告。
3. 在 AI 树洞中展示语音输入或表情识别。
4. 在虚拟角色中展示长期记忆、亲密度、关系阶段。
